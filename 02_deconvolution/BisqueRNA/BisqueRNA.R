...
outdir <- paste0(wdir, "02_deconvolution/BisqueRNA/") 
...
## Single-cell
sc_reference_sample_es <- readRDS(paste0(wdir, "01_prepare_input/sc_reference_sample_es.rds"))

## Markers
sc_ct_markers <- read_csv(paste0(wdir, "01_prepare_input/sc_ct_markers.csv"))
